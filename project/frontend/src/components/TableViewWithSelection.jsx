    ...
    updateParentCallback(params){
        ...
        if (params.req_id){
            ...
            sendRequestPromise(httpStr, 'POST',{})
                .then((data)=>{
                    var rowNode = this.gridApi.getRowNode(params.req_id);
                    ...
                    this.gridApi.refreshCells({ force: true, rowNodes: [this.gridApi.getRowNode(params.req_id)]});
