...
export default class TableViewConf extends Component {
    constructor(props) {
        super(props);
    ...
    getColumnsListRequestString(){
        var httpStr = "sht_columns/?viewType=ConfView";
        return httpStr;
    }

    getDataRequestString(){
        var httpStr = 'get_conf_list/?viewType=ConfView';
        return httpStr;
    }
        ...
        return (
            <div>
                <ReTableView
                    ...
                    additionalToolbarItem={()=>{return(<div className="toolbar-label">История утверждения</div>);}}
